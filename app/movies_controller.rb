...
def can_be_created_in_a_block(args = {})
  ...
  Movie.create do |m|
    m.title = args[:title] || args[:title] = "Home Alone" #CAN ALSO BE DONE AS args[:title] || "Home Alone"
    m.release_date = args[:release_date] || args[:release_date] = 1990 #CAN ALSO BE DONE AS args[:release_date] || 1990
  end
end
